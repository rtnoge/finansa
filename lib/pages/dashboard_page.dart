...
import 'package:finansa/widgets/bottomnavbar_ic.dart';
import 'package:finansa/widgets/button.dart';
import 'package:finansa/widgets/cards.dart';
import 'package:finansa/widgets/detail_notification.dart';
import 'package:finansa/widgets/shortcut_menu.dart';
...
class DashboardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
                  ...
                  Container(
                    ...
                    child: Align(
                      ...
                      child: Container(
                        ...
                        height: 8,
                        child: CircleAvatar(
                          backgroundColor: Color(0xffF79A2A),
                        ),
                      ),
                    ),
                  )
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [_navbar(), _cards(), _mainMenu()],
        ),
      ),
    );
  }
